...
function adminPage(){
 ...
 const tabs=[['profile','Business profile'],['users','Users & roles'],['objects','Custom Objects'],['fields','Custom fields'],['rules','Business rules'],['workflow','Workflow automation'],['transitions','Status transitions'],['numbering','Numbering'],['kpis','Dashboard KPIs']];
...
function renderAdminTab(){
 ...
 ({profile:profileTab,users:usersTab,objects:objectsTab,fields:fieldsTab,rules:rulesTab,workflow:workflowTab,transitions:transitionsTab,numbering:numberingTab,kpis:kpisTab}[adminTab])(body);
}
