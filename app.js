...
function roadmapPage(){
 ...
 const sequence=[
  ['1 · Global search & list-view filtering','Gives the existing is_searchable/is_filterable flags their first real use — the next scoped item now that Admin UX polish has shipped.',true],
  ['2 · Self-hosted internet deployment','Hardens the existing Team Workspace server (already binds 0.0.0.0) for exposure on the open internet — Secure cookies over HTTPS, a documented reverse-proxy/TLS recipe, and a CORS/security-headers pass.',false],
