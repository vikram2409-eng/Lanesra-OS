...
function roadmapPage(){
 ...
 <div class="backlog-callout" id="desktop"><h3>Release status</h3><p><b>desktop-v0.12.0 is the latest tagged release</b> (installers attached, Early Access/prerelease as intended) — it carries the Integration Hub work below (v0.35.0). Everything below is merged to <code>main</code>. Full desktop feature list → <a href="/download">/download</a>, full release history → <a href="/releases">/releases</a>.</p><p class="muted">Repo hygiene: a real MIT <code>LICENSE</code>, <code>CONTRIBUTING.md</code>, <code>CODE_OF_CONDUCT.md</code>, <code>SECURITY.md</code>, issue/PR templates, and a root README written for someone landing on the repo, not a deploy runbook.</p></div>
 </div></section>
