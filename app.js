...
function platformPage(){
 ...
 const industryApps=['Field Service','Property Management','Construction & Contractors','Professional Services','Practice Administration','Recruitment & Staffing','Real Estate Brokerage','Legal Practice','Nonprofit & Association Management','Auto Repair & Service Garage'];
 const layers=[
...
function comparePage(){document.title='Compare — Lanesra OS';
 ...
 const groups=[
  ...
  ['Apps, packaging & connections',[
   ['Ready-made industry apps to install, not just build','No','Marketplace/partner-built, not bundled','AppExchange, paid','Partner/ISV accelerators, several deprecated','Yes, 10 built in'],
 ...
 {key:'industry-data-model',label:'Industry Data Model',icon:'⬢',
  ...
  topics:[
   {slug:'install-an-industry-app',title:'Installing an industry app',
    ...
    sections:[
     {heading:'The flow: Import → Review → Install',bodyHtml:`<p><b>Admin → App Catalog</b> (under Apps) has three panels: <b>Import a package</b>, <b>Imported packages</b>, and <b>Installed apps</b>. Importing a package - pasting a manifest or clicking one of the 10 bundled starters - only adds it to this workspace's local catalog for review. <b>Nothing is created in your workspace until you click Install.</b></p>`},
     {heading:'The 10 bundled starters',bodyHtml:`<p>One click each loads a ready-to-review manifest for: Field Service, Property Management, Construction &amp; Contractors, Professional Services, Practice Administration, Recruitment &amp; Staffing, Real Estate Brokerage, Legal Practice, Nonprofit &amp; Association Management, and Auto Repair &amp; Service Garage. Loading a starter just fills the Import textarea with its JSON - you still choose whether to Import and then Install it.</p>`},
