  ...
  topics:[
   ...
   {slug:'extending-the-foundry',title:'Extending the Foundry',
    ...
    sections:[
     ...
     {heading:'What comes next',bodyHtml:`<p>This first Help category covers the AI &amp; Agentic Layer end to end. Detailed guides for <b>Core CRM &amp; No-Code Platform</b> are alongside it below; <b>App Catalog</b>, <b>Deployment Management</b> and <b>Integration Hub</b> are the named next categories for this Help section - not built yet, but planned, the same way this category itself started as a roadmap backlog item.</p>`},
    ]},
  ]},
