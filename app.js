...
function platformPage(){
 ...
 <section id="ai-layer" class="section"><div class="container narrow"><div class="section-head" style="text-align:center;margin:0 auto 8px"><div class="eyebrow">Built for agents, not bolted on</div><h2>The AI & Agentic Layer.</h2><p class="muted">MCP, a CLI, a Chat Assistant and a full AI Agent Foundry — all shipped, all running against the same data model below.</p></div><div class="platform-layers" style="max-width:820px;margin:0 auto"><article class="platform-layer-card"><div class="platform-layer-icon">${aiLayer.icon}</div><div class="eyebrow">${aiLayer.eyebrow}</div><h3>${aiLayer.name}</h3><p>${aiLayer.blurb}</p></article></div></div></section>
