...
function roadmapPage(){
 ...
 const sequence=[
  ['1 · Self-hosted internet deployment','Hardens the existing Team Workspace server (already binds 0.0.0.0) for exposure on the open internet — Secure cookies over HTTPS, a documented reverse-proxy/TLS recipe, and a CORS/security-headers pass. The next scoped item now that Global search & list-view filtering has shipped.',true],
  ['2 · Decide: Screen Designer, dashboard customization, Google sign-in, richer report builder, code signing','Several independent scope/budget calls, worth a deliberate conversation each rather than defaulting into months of work.',false],
 ];
 ...
 <section class="backlog-group"><div class="backlog-group-head"><h2>Up next</h2><span class="backlog-group-note">actively next in line, per the recommended sequencing below</span></div><p class="roadmap-row active">↻ ${planned[0][0]} — ${planned[0][1]}</p></section>
