   ...
   topics:[
    ...
    {slug:'access-roles-and-record-scopes',title:'Access Roles & Record Scopes',
     ...
     sections:[
      ...
      {heading:'Where this is actually enforced',bodyHtml:`<p>Reassigning a record's owner (<b>Admin → Access Roles</b>' original seam) always requires an explicit Assign grant covering that record. Beyond that, Create/Read/Update/Delete is checked one record at a time on Companies, Contacts, Opportunities, Products, Quotes, Orders, Invoices, Contracts, Tasks and Custom Object records - a create, an update, an archive, or opening one specific record. List views, search, dashboards, reports and related-record lists are <b>not</b> filtered by Access Role - a deliberate, bounded scope decision, not an oversight, kept separate from the deeper list-level enforcement a later phase may add.</p>`},
    ...
    {slug:'access-foundation-whats-next',title:"What's next: Field Access Policies, AI Access & Enterprise Identity",
     ...
     sections:[
      ...
      {heading:'What Phase 2 deliberately still leaves open',bodyHtml:`<p>Record-level enforcement is single-record only - list views, search, dashboards, reports and related-record lists stay unfiltered by design (see <a href="/help/access-roles-and-record-scopes">Access Roles &amp; Record Scopes</a>). Field-level read/write policies, reusable capability bundles, cross-cutting Access Groups and one-off time-bounded Record Grants are all real gaps the next phase closes, not this one.</p>`},
