...
function platformPage(){
 ...
 const layers=[
  ...
  {icon:'⬡',eyebrow:'Admin → Integration Hub',name:'Integration Hub',blurb:'Connects that same workspace to everything else your business runs: encrypted Connections, OpenAPI-imported Connectors, a generic REST API secured by scoped keys, HMAC-signed webhooks, a CSV data-exchange wizard, and scheduled Integration Jobs. Real on the desktop app and Team Workspace server; the online demo\'s version stays an explicitly labeled client-side simulation, since a static demo has no server to make a real call from.'},
 ];
