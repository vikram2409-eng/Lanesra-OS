...
use crate::services::{
    ...
    voice_policy_service, voice_provider_service,
};
...
pub fn first_run_setup(conn: &Connection, setup: &WorkspaceSetup) -> AppResult<(Workspace, User)> {
    ...
    voice_policy_service::ensure_workspace_default(conn, &workspace.id)?;
    voice_provider_service::ensure_defaults(conn, &workspace.id)?;
...
fn seed_sample_data(conn: &Connection, actor_user_id: &str, currency_code: &str) -> AppResult<()> {
    ...
    let acme = company_service::create(
        ...
        &CompanyInput {
            ...
            email: Some("hello@acmeconsulting.example".into()),
            website: Some("https://acmeconsulting.example".into()),
            annual_revenue_cents: Some(4_500_000_00),
    ...
    let northwind = company_service::create(
        ...
        &CompanyInput {
            ...
            notes: None,
            phone: None,
            email: Some("info@northwindtraders.example".into()),
            website: None,
            annual_revenue_cents: None,
            employee_count: Some(22),
    ...
    contact_service::create(
        ...
        &ContactInput {
            ...
            tags: None,
            notes: None,
            department: Some("Procurement".into()),
